...
export default function AdminAddFormModal({ onClose }: ModalProps) {
    ...
    // useState Hook to store the input value (category name)
    ...
    const createCategoryHandler = async (event: React.FormEvent) => {
        event.preventDefault(); // Prevent form default submission (page reload)
    ...
    return (
        ...
        >
            ...
            <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:w-full sm:max-w-lg">
                ...
                <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div className="text-center">
                        ...
                        <div className="mt-3">
                            ...
                            <form id="categoryForm" onSubmit={createCategoryHandler} className="max-w-md mx-auto mt-3">
                                {/* Category Name */}
                                <div className="relative z-0 w-full mb-5 group">
                                    <input
                                        ...
                                        name="category_name"
                                        id="category_name"
                                        value={categoryName} // binds input value to `categoryName` state
                                        onChange={handleInputChange} // calls my function when user types
                ...
                {/* Modal Footer - Full Width for buttons */}
                <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6 w-full">
                    <button
                        type="submit" // triggers form submission
                        form="categoryForm" // associate button with the form explicitly
    ...
    //                         <form onSubmit={createCategoryHandler} className="max-w-md mx-auto mt-3">
    //                             {/* Category Name */}
    //                             <div className="relative z-0 w-full mb-5 group">
    //                                 <input
    //                                     type="text"
